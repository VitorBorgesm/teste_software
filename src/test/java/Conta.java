...
public class Conta {
	/**
	 * 
	 * aqui sera escrito a documentação da etapa 3 a
	 */
	...
	@Given("um cliente comum com saldo de {int} reais")
	public void um_cliente_comum_com_saldo_de_reais(Integer int1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
